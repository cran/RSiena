 ...
 *
 * File: TwoPathFunction.cpp
 *
 * Description: This file contains the implementation of the class
 * TwoPathFunction.
 *****************************************************************************/

#include "TwoPathFunction.h"
 ...
 * associated with
 */
TwoPathFunction::TwoPathFunction(string networkName) :
 ...
 */
void TwoPathFunction::initialize(const Data * pData,
	State * pState,
	int period,
	Cache * pCache)
{
 ...
 */
int TwoPathFunction::intValue(int alter)
{
	return this->lpTable->get(alter);
}
