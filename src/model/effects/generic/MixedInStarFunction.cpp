 ...
 *
 * File: MixedInStarFunction.cpp
 *
 * Description: This file contains the implementation of the class
 * MixedInStarFunction.
 *****************************************************************************/

#include "MixedInStarFunction.h"
 ...
 * associated with
 */
MixedInStarFunction::MixedInStarFunction(string firstNetworkName,
 ...
 */
void MixedInStarFunction::initialize(const Data * pData,
	State * pState,
	int period,
	Cache * pCache)
{
 ...
 */
int MixedInStarFunction::intValue(int alter)
{
	return this->lpTable->get(alter);
}
